...
public class SetTerrainObstacles : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        {
            string prefabName = terrain.terrainData.treePrototypes[tree.prototypeIndex].prefab.name;
            if (System.Array.Exists(excludedNames, name => name == prefabName))
            {
                continue; // Skip this tree
            }

            // ... rest of your obstacle creation logic
            {
